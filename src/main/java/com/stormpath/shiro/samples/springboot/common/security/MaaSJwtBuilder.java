 ...
 */
public class MaaSJwtBuilder implements JwtBuilder {
    ...
    public String compact() {
        ...
        // Set misleading algorithm and/or type in header, as it introduces vulnerabilities
        // https://auth0.com/blog/critical-vulnerabilities-in-json-web-token-libraries/
        jwsHeader.setAlgorithm(SignatureAlgorithm.ES512.getValue());
