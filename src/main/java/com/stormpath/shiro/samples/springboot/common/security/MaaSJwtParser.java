...
/**
 * Created by cbarad on 2016-10-13.
 */
public class MaaSJwtParser implements JwtParser {
    ...
    public JwtParser setSigningAlgorithm(SignatureAlgorithm signatureAlgorithm) {
    ...
    public Jwt parse(String jwt) throws ExpiredJwtException, MalformedJwtException, SignatureException {
        ...
        if (base64UrlEncodedDigest != null) { //it is signed - validate the signature
            ...
            SignatureAlgorithm algorithm = this.signatureAlgorithm;

            if (header != null && algorithm == null) {
